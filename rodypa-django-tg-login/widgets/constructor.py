"""
Widget constructing functions.
"""

from tg_authorization.widgets.constants import SMALL

WIDGET_SCRIPT_START = '<script async src="https://telegram.org/js/telegram-widget.js?22" '
